...
public class UsersApiController implements UsersApi {
    ...
    @Override
    public ResponseEntity<UserResponse> changeUserRole(Long id, @Valid RoleUpdateRequest roleUpdateRequest) {
        log.debug("changeUserRole invoked id={}, role={}", id, roleUpdateRequest.getRole());

        UserResponse updatedUserProfile = userService.changeRole(id, roleUpdateRequest);
